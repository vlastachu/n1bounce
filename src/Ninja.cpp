...
void Ninja::draw()
{
	...
	*/
	Texture::findByName("leg")->draw(parent->toX(leg1.x+x)   , parent->toY(leg1.y+y)   , parent->toL(leg1.w)   , parent->toL(leg1.h)   ,0.5,0.5,   leg1.rot);//TODO save pointer
	Texture::findByName("ninja")->draw(parent->toX(body.x+x)   , parent->toY(body.y+y)   , parent->toL(body.w)   , parent->toL(body.h)   ,0.5,0.5,   body.rot);//TODO save pointer
	Texture::findByName("katana")->draw(parent->toX(katana.x+x) , parent->toY(katana.y+y) , parent->toL(katana.w) , parent->toL(katana.h) ,0.5,0.5, katana.rot);//TODO save pointer
	Texture::findByName("leg")->draw(parent->toX(leg2.x+x)   , parent->toY(leg2.y+y)   , parent->toL(leg2.w)   , parent->toL(leg2.h)   ,0.5,0.5,   leg2.rot);//TODO save pointer
}
